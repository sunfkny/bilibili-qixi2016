...
tidSet = [1, 3, 4, 5, 11, 13, 23, 36, 119, 129, 155, 160, 165, 167, 181, 177];
...
LoadWebp = {
	...
	setSrc: function(g) {
		...
		var j = "",
		j = g.match(/_(\d+)x(\d+)./),
		f = -1 != g.indexOf("https://www.bilibili.com/bfs/") ? !0 : !1,
...
utils = {
	...
	webp: function(j, q) {
		...
		o = "";
		i = j.match(/_(\d+)x(\d+)./);
		var o = -1 != j.indexOf("https://www.bilibili.com/bfs/") ? !0 : !1,
	...
	customReport: function(b, d) {
		window.spmReportData && (window.spmReportData[b] = d ? d: b)
	},
	avLink: function(b) {
		return b.replace(/av([0-9]+)/g, '<a target="_blank" href="//www.bilibili.com/video/av$1">av$1</a>')
	},
	smLink: function(b) {
		return b.replace(/sm([0-9]+)/g, '<a target="_blank" href="http://acg.tv/sm$1">sm$1</a>')
	}
};
...
// 		function() {
// 			var c = p.find('input[name="reason"]:checked').val(),
...
// 					A.close()
// 				},
// 				3000)) : 12019 == f.code ? (new MessageBox).show(b, "\u4e3e\u62a5\u8fc7\u4e8e\u9891\u7e41\uff0c\u8bf7" + f.data.ttl + "\u79d2\u540e\u91cd\u8bd5") : (new MessageBox).show(b, "\u63d0\u4ea4\u5931\u8d25\uff0c\u8bf7\u91cd\u8bd5")
// 			}).fail(function() { (new MessageBox).show(b, "\u63d0\u4ea4\u5931\u8d25\uff0c\u8bf7\u91cd\u8bd5")
// 			}).complete(function() {
// 				b.css({
// 					"background-color": "",
// 					color: ""
...
// 			for (var k = p.find(".reason-set").css({
// 				width: 200,
// 				"text-align": "left",
// 				"padding-top": "10px"
// 			}), n = 0; n < E.length; n++) {
// 				$('<label style="cursor:pointer;"><input style="vertical-align:middle; margin-top:2px; margin-right:5px;" type="radio" name="reason" value="' + (n + 1) % 9 + '"/><span style="vertical-align:middle;">' + E[n] + "</span></label>").css({
// 					"vertical-align": "top",
// 					width: "98px",
// 					"line-height": "24px",
...
// 				$(".user_face>img", d).attr("src", "./images/member/noface.gif");
...
// 			d = $('<li><a class="re_face" href="//space.bilibili.com/' + f.member.mid + '" mid="' + f.member.mid + '" target="_blank" card="' + f.member.uname + '"><img src="' + utils.thumbnail(f.member.avatar, 52, 52) + '" /></a>                <div class="re_cnt">                   <div class="w"><a class="name" href="//space.bilibili.com/' + f.member.mid + '" mid="' + f.member.mid + '" target="_blank" card="' + f.member.uname + '">' + f.member.uname + '</a><a href="//www.bilibili.com/html/help.html#k_3" target="_blank" class="user-info-level l' + (f.member.level_info ? f.member.level_info.current_level: 0) + '"></a><span class="content"></span></div>                    <div class="info">                       <p>                            <span class="floor-date">' + t(f.ctime) + "</span>" + (0 <= this.isAdmin ? '        <a class="zan" onclick="javascript:;"></a>': "") + (0 <= this.isAdmin ? '      <a class="re_ta" href="javascript:;;">\u56de\u590d</a>': "") + (0 <= this.isAdmin ? '      <a class="jubao">\u4e3e\u62a5</a>': "") + "                        </p>                    </div>                </div>            </li>").attr("id", "l_id_" + f.rpid).appendTo(k);
// 			f.member.vip && (2 == f.member.vip.vipType && 1 == f.member.vip.vipStatus && 2 != f.member.vip.vipStatus) && d.find(".re_cnt a.name").eq(0).addClass("b-vip-red");
// 			var h = this;
// 			k = d.find(".content");
// 			var e;
// 			h.recordToObject(k, f, e || 0);
// 			1 == h.isAdmin && (e = $('<a href="javascript:;" title="\u88ab\u9690\u85cf\u540e\uff0c\u5176\u4ed6\u7528\u6237\u4f1a\u9ed8\u8ba4\u4e0d\u663e\u793a\u8be5\u8bc4\u8bba" class="no hidefb">\u9690\u85cf\u8be5\u8bc4\u8bba</a>').appendTo(d.find(".info p")).click(function() {
// 				v(this, h.id, h.type, f.rpid, !0);
// 				return ! 1
// 			}), k = $('<a href="javascript:;" class="yes showfb">\u663e\u793a\u8be5\u8bc4\u8bba</a>').appendTo(d.find(".info p")).click(function() {
// 				v(this, h.id, h.type, f.rpid, !1);
// 				return ! 1
// 			}), 0 == f.state || 6 == f.state || 2 == f.state ? k.hide() : e.hide());
// 			0 <= h.isAdmin && (d.find(".jubao").click(function() {
// 				return u(this, h.id, h.type, f.rpid)
// 			}), h.bindAgree(d.find(".zan"), f));
// 			h.pushUser(f.member.mid, d);
// 			d.find(".re_ta").click(function() {
// 				h.re_send_show($(this).parents(".reply").find(".re_send"), $(this).parents(".re_cnt").find(".name").html(), f.rpid, f.root)
// 			});
// 			return d
// 		},
...
// 			}
// 			var p = this,
// 			k, n; ! 1 !== C && (k = this._quoteID, n = this._rootQuoteID);
// 			C = {
...
// 						1 != p.page || ("0" != p.orderby || k || "function" == typeof B) || setTimeout(function() {
// 							p.load(1)
// 						},
// 						200);
// 						if (k) {
// 							var e = D.parent(),
// 							b = e.find(".re_ul"),
// 							d = e.find(".pagelistbox"),
// 							a = parseInt(d.attr("data-page")),
// 							g = parseInt(d.attr("data-results")) || b.children().length; (e.find(".re_more").length || a) && a != Math.ceil(g / 10) || setTimeout(function() {
// 								p.loadReply(d, b, n || k, Math.ceil((g + 1) / 10))
// 							},
// 							200)
// 						}
// 						p.removeCaptcha();
...
// 				}
// 			} else {
// 				null != g ? (k.show(), k.find(".ipt-txt").val(""), s($(".ipt-txt", k).get(0), "\u56de\u590d @" + g + " :")) : "" == k.find(".ipt-txt").val() || k.parent().hasClass("empty") ? (g = 0 == h.find(".re_ul").children().length ? !0 : !1, "none" != k.css("display") ? (k.hide(), g && h.hide()) : (k.show(), g && h.show())) : k.find(".ipt-txt").val("")
// 			}
...
// 			n = $('<div class="tab-slider clearfix"><span class="prev"></span><span class="next on"></span></div>'),
// 			z = A.find(".tab-nowrap"),
// 			p = {
// 				total: 1,
// 				current: 0,
...
// 				firsrPid: null,
// 				slider: function(b) {
// 					1 == b && (this.current + this.maxShow < this.total ? (this.current += this.maxShow, n.find(".prev").addClass("on"), this.current + this.maxShow >= this.total && n.find(".next").removeClass("on")) : this.current = this.total - this.maxShow); - 1 == b && (0 <= this.current - this.maxShow ? (this.current -= this.maxShow, n.find(".next").addClass("on"), 0 > this.current - this.maxShow && n.find(".prev").removeClass("on")) : this.current = 0);
// 					z.css("left", -this.current * this.tabWidth)
// 				},
// 				renderDefault: function() {
// 					z.append('<a class="emoji-tab tab-i on" data-pid="emoji"><img src="./images/base/emoji-tab-default.png"></a>');
// 					B.html(F.emoji)
// 				},
...
// 							if (g = "", l = I.data[b], H = l.emojis, $.isArray(H) && H.length && !l.pstate) {
// 								null == p.firsrPid && (p.firsrPid = l.pid);
// 								for (var a = 0; a < H.length; a++) {
// 									1 != H[a].state && (h = H[a], k = (h.name.split("_")[1] || "").slice(0, -1), g += '<span data-emoji-text="' + h.name + '"><img title="' + k + '" alt="' + h.name + '" data-id="' + h.id + '" data-state="' + h.state + '" data-img="' + utils.thumbnail(h.url, 40) + '"></span>')
// 								}
// 								F[l.pid] = g;
// 								F[l.pid + "_name"] = l.pname || "";
// 								$("<a>", {
// 									"class": "emoji-tab tab-i",
// 									"data-pid": l.pid,
// 									html: $("<img>", {
// 										"data-img": utils.thumbnail(l.purl, 22),
// 										alt: l.pname
// 									})
// 								}).appendTo(z);
// 								z.width(++p.total * p.tabWidth)
// 							}
// 						}
// 						p.total > p.maxShow && (A.find(".tabs-wrap").append(n), n.on("click", ".prev.on",
// 						function() {
// 							p.slider( - 1)
// 						}).on("click", ".next.on",
// 						function() {
...
// 								c.isLogin && (0 < c.vipType && 0 != c.vipStatus) && z.find('[data-pid="' + p.firsrPid + '"]').eq(0).trigger("click")
// 							},
// 							!0)
// 						})
// 					}
...
// 				var c = f.target;
// 				if (12002 === g.code) {
// 					f._sender.find(".submit-comment").off("click.commentSubmitMsg").addClass("disabled"),
// 					f._sender.find(".login-link-wrp").remove(),
// 					f._sender.find("#dcmp_textarea_container").addClass("disabled").prepend($('<div class="login-link-wrp">\u672c\u89c6\u9891\u8bc4\u8bba\u529f\u80fd\u5df2\u5173\u95ed</div>')),
// 					d.remove()
// 				} else {
...
// 						C && g.data.page && (f.page = E = g.data.page.num);
// 						f._loaded = !0;
...
// 						$('li[order="' + f.orderby + '"]', b).addClass("on");
// 						$("li", b).click(function() {
// 							var B = $(this);
// 							B.hasClass("on") || ($("li", b).removeClass("on"), B.addClass("on"), f.orderby = B.attr("order"), f.load(1))
// 						});
// 						var n = $('<ul class="comm_list"></ul>').appendTo(c),
// 						l = $('<div class="pagelistbox"></div>').appendTo(c),
// 						k = $('<div class="pagelistbox small"></div>').appendTo(b);
// 						pagelist(l, E, Math.ceil(g.data.page.count / g.data.page.size), g.data.page.count,
// 						function(B) {
// 							f.load(B);
// 							$(window).scrollTop($(f.target).offset().top + $(".z_top").outerHeight())
// 						},
// 						null, 2, !0);
// 						"mobile" == f.platform && l.addClass("small");
// 						pagelist(k, E, Math.ceil(g.data.page.count / g.data.page.size), g.data.page.count,
// 						function(B) {
// 							f.load(B)
// 						},
// 						null, 2);
// 						g.data.replies.length && 0 != g.data.page.acount || $('<div class="no_more">\u6ca1\u6709\u66f4\u591a\u4fe1\u606f</div>').appendTo(n);
...
// 						for (l = 0; l < g.data.replies.length; l++) {
// 							"object" == typeof g.data.replies[l] &&
// 							function(D) {
...
// 									0 === D.root && D.content.message && (D.content.message = D.content.message.replace(/\[[^\[]*]/g,
// 									function(M) {
// 										return $("<img>", a[M]).prop("outerHTML") || M
// 									}));
// 									var J = $('<li id="l_id_' + D.rpid + '" class="main-floor"><div class="facebox"><a href="//space.bilibili.com/' + D.member.mid + '" target="_blank" mid="' + D.member.mid + '" card="' + D.member.uname + '"><img src="' + utils.thumbnail(D.member.avatar, 52, 52) + '" class="face"></a><a href="//space.bilibili.com/' + D.member.mid + '" mid="' + D.member.mid + '" target="_blank" class="face_bg" card="' + D.member.uname + '">' + (D.member.pendant && 0 < D.member.pendant.pid ? '<img src="' + utils.thumbnail(D.member.pendant.image, 86) + '" alt="' + D.member.pendant.name + '" />': "") + L + '</a></div><div class="t"><a href="//space.bilibili.com/' + D.member.mid + '" target="_blank" mid="' + D.member.mid + '" card="' + $("<div/>").text(D.member.uname).html() + '">' + $("<div/>").text(D.member.uname).html() + '</a><a href="//www.bilibili.com/html/help.html#k_3" target="_blank" class="user-info-level l' + (D.member.level_info ? D.member.level_info.current_level: 0) + '"></a>' + (D.member.nameplate && 0 < D.member.nameplate.nid ? '<a href="https://account.bilibili.com/site/nameplate" target="_blank" class="member-nameplate" nameplate-id="' + D.member.nameplate.nid + '"><img src="' + utils.thumbnail(D.member.nameplate.image_small, 32) + '" alt="' + D.member.nameplate.name + '" /></a>': "") + '</div><div class="content"></div><div class="elinfo"><span class="floor-num">#' + D.floor + "</span>" + (D.content.plat && 1 < D.content.plat ? '<span class="floor-plat">\u6765\u81ea<a href="//app.bilibili.com/" target="_blank">' + ("2" == D.content.plat ? "\u5b89\u5353\u5ba2\u6237\u7aef": "") + ("3" == D.content.plat ? "iOS\u5ba2\u6237\u7aef": "") + ("4" == D.content.plat ? "Windows Phone\u5ba2\u6237\u7aef": "") + "</a></span>": "") + '<span class="floor-date">' + t(D.ctime) + '</span></span><i class="report"></i></div></li>').appendTo(n);
// 									D.member.vip && (2 == D.member.vip.vipType && 0 != D.member.vip.vipStatus && 2 != D.member.vip.vipStatus) && J.find(".t > a").eq(0).addClass("b-vip-red");
// 									f.pushUser(D.member.mid, J);
// 									L = J.find(".content");
// 									f.recordToObject(L, D);
// 									if (null != D.replies) {
// 										for (var B = $('<div class="reply"><ul class="re_ul"></ul><div class="re_box">' + (5 < D.rcount ? '<p class="re_more"><span>\u8fd8\u6709<b>' + (D.rcount - 5) + '</b>\u6761\u56de\u590d\uff0c</span><a class="re_more_s">\u70b9\u51fb\u67e5\u770b</a></p>': "") + '<div class="re_page">   <div class="pagelistbox small">   </div></div></div><div class="re_send"></div></div>').appendTo(J), I = $(".re_ul", B), G = 1, L = 0; L < D.replies.length; L++) {
// 											f.reply_render(D.replies[L], D.rpid, I),
// 											C && (D.replies[L].rpid == C && g.data.page.rt_num) && (G = g.data.page.rt_num)
// 										}
// 										$(".re_more_s", B).click(function() {
// 											$(".re_more", B).remove();
// 											f.loadReply($(".pagelistbox", B), I, D.rpid, G)
// 										})
// 									}
// 									var L = J.find(".report"),
// 									K,
// 									H = $('<a href="javascript:;" class="huifu">\u56de\u590d</a>').appendTo(L).click(function() {
// 										0 == J.find(".reply").length ? (K = $('<div class="reply"><ul class="re_ul"></ul><div class="re_box"><p class="j_re"><a class="re_send_s" href="javascript:;">\u53c2\u4e0e\u56de\u590d</a></p><div class="re_page"> <div class="pagelistbox"></div></div></div><div class="re_send"></div></div>').appendTo(J), $(".re_box", K).hide(), $(".re_send_s", K).click(function() {
// 											f.re_send_show(K.find(".re_send"), null, D.rpid)
// 										})) : K = J.find(".reply");
// 										K.find(".re_ul");
// 										f.re_send_show(K.find(".re_send"), null, D.rpid)
// 									});
// 									D.replies && D.replies.length && H.addClass("reply-b").text("\u53c2\u4e0e\u56de\u590d");
...
// 									1 == f.isAdmin && (H = $('<a href="javascript:;" title="\u88ab\u9690\u85cf\u540e\uff0c\u5176\u4ed6\u7528\u6237\u4f1a\u9ed8\u8ba4\u4e0d\u663e\u793a\u8be5\u8bc4\u8bba" class="no hidefb">\u9690\u85cf\u8be5\u8bc4\u8bba</a>').appendTo(L).click(function() {
// 										v(this, p, f.type, D.rpid, !0);
// 										return ! 1
// 									}), L = $('<a href="javascript:;" class="yes showfb">\u663e\u793a\u8be5\u8bc4\u8bba</a>').appendTo(L).click(function() {
// 										v(this, p, f.type, D.rpid, !1);
// 										return ! 1
// 									}), 0 == D.state || 6 == D.state || 2 == D.state ? L.hide() : H.hide())
// 								}
// 							} (g.data.replies[l])
// 						}
// 						f.checkFeed(f.id);
...
// 			E = this.page;
// 			var f = this,
// 			F = 4 == f.type ? 4 : "topic" == f.type ? 2 : 1,
// 			e = i.base + i.list.getReply + "?jsonp=jsonp&type=" + F + "&sort=" + f.orderby + "&oid=" + f.id + "&pn=" + E + "&r=" + Math.random() + "&nohot=1";
// 			C && (e = i.base + i.list.getPosition + "?jsonp=jsonp&rpid=" + C + "&type=" + F + "&oid=" + f.id + "&pn=" + E + "&r=" + Math.random() + "&nohot=1");
...
// 						var B = G.data[D].emojis;
// 						if ($.isArray(B) && B.length) {
// 							for (var n = 0; n < B.length; n++) {
// 								H[B[n].name] = {
// 									"class": "b-vip-emoji",
// 									title: (B[n].name.split("_")[1] || "").slice(0, -1),
// 									src: utils.thumbnail(B[n].url, 50),
// 									alt: B[n].name
// 								}
// 							}
// 						}
...
// 					1 === b.vipStatus && f.emojiXHR.resolve(G)
// 				},
// 				!0);
// 				h(l[0], H)
// 			})
...
// 	function(a) { - 665 == a.code ? $.getScript("./plugins/attentionLimitPopup/attentionLimitPopup.js",
// 		function() {
...
// 	})
// }
// function followUser(g, j, f, i, h) {
// 	if (!UserStatus.isLogin(g, h)) {
// 		return ! 1
// 	}
// 	Bilibili.followUser(g, j, f,
// 	function(a) {
// 		22006 == a.code ? $.getScript("./plugins/attentionLimitPopup/attentionLimitPopup.js",
// 		function() {
// 			new attentionLimitPopup
// 		}) : 0 == a.code ? (window.AttentionList.push(parseInt(j)), resetAttentionCache(), "undefined" != typeof i && i(a)) : (new MessageBox).show(g, a.message, 2000, "warning")
// 	})
// }
// function unfollowUser(g, j, f, i, h) {
// 	if (!UserStatus.isLogin(g)) {
// 		return ! 1
// 	}
// 	Bilibili.unfollowUser(g, j, f,
// 	function(a) {
// 		if (0 == a.code) {
// 			var c = window.AttentionList.indexOf(parseInt(j)); - 1 != c && (window.AttentionList.splice(c, 1), resetAttentionCache());
// 			"undefined" != typeof i && i(a)
// 		} else { (new MessageBox).show(g, a.message, 2000, "warning")
// 		}
// 	},
// 	h)
// }
...
// 		})
// 	},
// 	followUser: function(f, h, e, g) {
// 		"function" == typeof h ? (g = h, h = f, f = null) : "undefined" == typeof h && (h = f, f = null);
// 		$.ajax({
...
// 			}
// 		}).done(function(a) {
// 			"undefined" == typeof g ? 0 == data.code ? (new MessageBox).show(f, "\u5173\u6ce8\u6210\u529f!", 1000, "ok") : (new MessageBox).show(f, a.message, 2000, "warning") : g(a)
// 		})
// 	},
// 	unfollowUser: function(g, j, f, i, h) {
// 		"function" == typeof j ? (i = j, j = g, g = null) : "undefined" == typeof j && (j = g, g = null);
// 		$.ajax({
// 			url: "//api.bilibili.com/x/relation/modify?cross_domain=true",
// 			type: "POST",
// 			data: {
...
// 			}
// 		}).done(function(a) {
// 			h && (window.isQuietAttention = !1);
// 			"undefined" == typeof i ? 0 == data.code ? (new MessageBox).show(g, "\u5173\u6ce8\u6210\u529f!", 1000, "ok") : (new MessageBox).show(g, a.message, 2000, "warning") : i(a)
// 		})
// 	},
...
// 	function E(b) {
// 		j.offset().top > $(window).scrollTop() + 244 ? i.css("top", j.offset().top - 244 + "px") : i.css("top", j.offset().top + 68 + "px");
// 		j.offset().left + $(".a-layer").outerWidth() > $(window).width() ? i.css("left", j.offset().left - 5 - (j.offset().left + $(".a-layer").outerWidth() - $(window).width()) + "px") : i.css("left", j.offset().left + "px");
...
// 	function C(a) {
// 		clearTimeout(s);
// 		F && ($(".a-layer").remove(), i = $('<div class="a-layer"><div class="content"><div class="bg_top"></div><div class="msg">' + a + "</div></div></div>").appendTo("body"), E())
// 	}
// 	function D(d) {
// 		var c = d.data.card;
// 		d = d.data.space;
// 		clearTimeout(s);
// 		F && "undefined" == typeof c.mid ? C("\u62b1\u6b49\uff0c\u8be5\u6635\u79f0\u76ee\u524d\u4e0d\u5b58\u5728\u54e6(*^__^*)") : (c.top_photo = "../../i0.hdslb.com/bfs/static/c9dae917e24b4fc17c4d544caf6b6c0b17f8692b.jpg", d && d.s_img && (c.top_photo = d.s_img), B(c))
// 	}
// 	function B(a) {
// 		if (F) {
// 			G[a.name] = a;
...
// 			i.find(".layer-follow-btn").html(A(f));
// 			e || $.getScript("./common/js/followGroupDialog.js",
// 			function() {
// 				$(".a-layer").remove();
// 				followGroupDialog(f.mid, f.name, {
// 					showErrMsgInDialog: !1,
// 					onAddTagError: function(b) { (new MessageBox).show($(".follow-dialog-window .submit"), b || "\u6dfb\u52a0\u5206\u7ec4\u5931\u8d25")
// 					},
// 					onSubmitError: function(b) { (new MessageBox).show($(".follow-dialog-window .submit-move"), b || "\u79fb\u52a8\u5206\u7ec4\u5931\u8d25")
// 					},
// 					onSubmitSuccess: function() { (new MessageBox).show($(".follow-dialog-window"), "\u52a0\u5165\u5206\u7ec4\u6210\u529f")
// 					},
// 					onEmptyTagSubmit: function() { (new MessageBox).show($(".follow-dialog-window"), "\u52a0\u5165\u5206\u7ec4\u6210\u529f")
// 					}
// 				})
// 			})
// 		};
// 		e ? (h = $('<a href="javascript:;">\u5df2\u5173\u6ce8</a>'), h.filter("a").on({
// 			click: function() {
// 				unfollowUser(this, f.mid, 15, g, f.quiet)
// 			},
// 			mouseenter: function() {
// 				$(this).html("\u53d6\u6d88\u5173\u6ce8")
// 			},
...
// 				$(this).html("\u5df2\u5173\u6ce8")
// 			}
// 		})) : (h = $('<a href="javascript:;">+\u5173\u6ce8</a>'), h.on("click",
// 		function() {
// 			followUser(this, f.mid, 15, g);
// 			utils.customReport("playpage_follow2")
// 		}));
// 		return h
// 	}
// 	function z() {
...
// 					dataType: "jsonp"
// 				}).done(function(a) {
// 					0 === a.code && a.data && (d.data.card.following = 1 === a.data.attribute || 2 === a.data.attribute || 6 === a.data.attribute, d.data.card.quiet = 1 === a.data.attribute);
// 					D(d)
// 				})
// 			},
// 			error: function() {
...
// 			utils.customReport("playpage_namecard1");
// 			y(d, c)
// 		},
// 		500)
// 	}
...
// 			d && d.preventDefault(); ! browser.version.mobile || browser.version.iPad ? RequireModule.getScript("biliQuickLogin", "./account/bili_quick_login.js",
// 			function() {
...
// 	f.isLogin || RequireModule.getScript("biliQuickLogin", "./account/bili_quick_login.js",
// 	function() {
...
// 			h.vipType && 0 != h.vipStatus && (2 == h.vipType && 2 != h.vipStatus && $(".uname > b", g).addClass("b-vip-red"), l[h.vipType] && 2 != h.vipStatus && $(".uname", g).append('<div class="layer-row"><a href="//account.bilibili.com/account/big" target="_blank"><span class="vip-hinter" data-vip-type="' + h.vipType + '">' + l[h.vipType] + "</span></a></div>"));
...
// 			initLiveDyn();
// 			initArticleDyn();
// 			RequireModule.registerScript("messageModule", "message/message.v1.min.html");
...
// 				})
// 			}
// 			$("#i_menu_fav_btn .i-link").attr("href", "//space.bilibili.com/" + (UserStatus.status().mid || utils.__GetCookie("DedeUserID")) + "/#!/favlist")
// 		} else {
// 			initMiniWnd(!0),
// 			$('li[guest="no"]').hide(),
// 			$('li[guest="yes"]').show()
...
// 	// 	e()
// 	// }
// 	// f && document.getElementById("player_placeholder") && (f = document.getElementById("player_placeholder"), f.mukio_reloadAccess && f.mukio_reloadAccess())
// }
...
// 	})
// }
// function profileWnd(C) {
// 	var A = $("#i_menu_profile_btn"),
// 	B = $("#i_menu_profile"),
// 	z = A.find(".i_face"),
// 	y = B.find(".info").addClass("clearfix"),
// 	x = B.find(".coin");
// 	if (A.length) {
// 		B.find(".member-menu .notice").parents(".member-menu").remove();
// 		B.find(".member-menu a").attr("target", "_blank");
// 		if (0 == C.email_verified && 0 == C.mobile_verified) {
// 			var w = $('<a class="phone" href="https://passport.bilibili.com/member/bindphone.html" target="_blank"></a>').attr({
// 				tips: "\u524d\u53bb\u7ed1\u5b9a\u624b\u673a",
// 				"tips-pos": "l"
// 			}),
// 			v = $('<a class="email" href="https://passport.bilibili.com/member/bindmail.html" target="_blank"></a>').attr({
// 				tips: "\u524d\u53bb\u7ed1\u5b9a\u90ae\u7bb1",
// 				"tips-pos": "l"
// 			})
// 		} else {
// 			1 == C.email_verified && 0 == C.mobile_verified ? (w = $('<a class="phone" href="https://passport.bilibili.com/member/hasmailcheckmail.html" target="_blank"></a>').attr({
// 				tips: "\u524d\u53bb\u7ed1\u5b9a\u624b\u673a",
// 				"tips-pos": "l"
// 			}), v = $('<a class="email verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
// 				tips: "\u5df2\u7ed1\u5b9a",
// 				"tips-pos": "l"
// 			})) : 0 == C.email_verified && 1 == C.mobile_verified ? (w = $('<a class="phone verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
// 				tips: "\u5df2\u7ed1\u5b9a",
// 				"tips-pos": "l"
// 			}), v = $('<a class="email" href="https://passport.bilibili.com/member/hasphonecheckphone.html" target="_blank"></a>').attr({
// 				tips: "\u524d\u53bb\u7ed1\u5b9a\u90ae\u7bb1",
// 				"tips-pos": "l"
// 			})) : 1 == C.email_verified && 1 == C.mobile_verified && (w = $('<a class="phone verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
// 				tips: "\u5df2\u7ed1\u5b9a",
// 				"tips-pos": "l"
// 			}), v = $('<a class="email verified" href="https://account.bilibili.com/" target="_blank"></a>').attr({
// 				tips: "\u5df2\u7ed1\u5b9a",
...
// 			}))
// 		}
// 		y.find(".phone, .email").remove();
// 		y.append(w).append(v);
// 		y.find(".coin").attr("title", "\u786c\u5e01");
// 		B.find(".coin").parent().is("a") || B.find(".coin").wrap('<a href="https://account.bilibili.com/site/coin" target="_blank"></a>');
// 		C.pendant && C.pendant.image ? ($("<img>", {
// 			"class": "i_face-pendant hide",
// 			src: utils.trimHttp(C.pendant.image),
// 			alt: C.pendant.name
// 		}).insertAfter(z), z.addClass("has_pendant")) : z.removeClass("has_pendant");
...
// 			B.is(":visible") || (z.addClass("scale-in"), b[c] == u() && x.removeClass("hover-first").addClass("hover-again"), B.stop().slideDown(200,
// 			function() {
// 				t.removeClass("hide");
// 				$(".legalize-icon", A).show();
// 				b[c] != u() && C.mobile_verified && (b[c] = u(), utils.localStorage.setItem("time_tracker", JSON.stringify(b)), $("#i_menu_profile .info a.linkToCurrency").addClass("off"), setTimeout(function() {
// 					$("#i_menu_profile .info a.linkToCurrency").removeClass("off").addClass("on")
// 				},
// 				3000), x.removeClass("hover-again").addClass("hover-first"))
// 			}))
// 		},
// 		function() {
// 			t.addClass("hide");
// 			$(".legalize-icon", A).hide();
// 			B.stop().slideUp(200,
// 			function() {
// 				x.removeClass("hover-first hover-again")
// 			});
// 			z.removeClass("scale-in")
// 		});
// 		ToolTips.bind(B, 5, !1, "nav-tool-tip");
// 		B.find(".user-info").remove();
// 		var o = null;
// 		C.level_info || (C.level_info = {
// 			current_level: 0,
// 			current_min: 0,
// 			current_exp: 0,
// 			next_exp: 0
// 		});
// 		for (var s in C.level_info) {
// 			C.level_info[s] = parseInt(C.level_info[s]) >> 0
// 		}
// 		0 === C.level_info.next_exp >> 0 && (C.level_info.next_exp = "-");
// 		w = C.level_info;
// 		v = $('<a class="help-link" href="//www.bilibili.com/html/help.html#k" target="_blank">\u4f1a\u5458\u7b49\u7ea7\u76f8\u5173\u8bf4\u660e ></a>');
// 		s = $('<div class="user-info" id="lv_info"><div class="user-info-hd"><span class="t">\u7b49\u7ea7</span></div><div class="points-wrp" id="exp_wrp"><a href="https://account.bilibili.com/site/record?type=exp" target="_blank"><div class="points-cnt"><div class="lt"></div><div class="fill-el"></div><div class="bar"><div class="points"></div></div><div class="points-schedule"><span class="now-points">' + w.current_exp + '</span><span class="next-points">/' + w.next_exp + "</span></div></div></a></div></div>").addClass("l" + w.current_level).insertAfter(B.find(".info"));
// 		var j = s.find("#exp_wrp");
// 		0 == w.current_level && s.find(".points-schedule").html('<a class="lv-0" href="https://account.bilibili.com/answer/base" target="_blank">\u7b54\u9898\u8f6c\u6b63\u76f4\u5347Lv' + (w.after_answer || 1) + "</a>");
// 		var i = $('<div class="user-info-desc"><span class="arrow-left"></span><div class="lv-row">\u4f5c\u4e3a<strong>LV' + w.current_level + "</strong>" + (0 == w.current_level ? "\uff0c\u4f60\u65e0\u6cd5\u4eab\u53d7\u7279\u6743": "\uff0c\u4f60\u53ef\u4ee5\uff1a") + "</div><div>" + "\u6210\u4e3a\u6b63\u5f0f\u4f1a\u5458\uff0c\u4f60\u53ef\u4ee5\uff1a<br/>1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u8bc4\u8bba<br/>3\u3001\u767b\u5f55\u83b7\u5f97\u786c\u5e01<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u6eda\u52a8\u5f39\u5e55<br/>2\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>2\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>3\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u8d2d\u4e70\u9080\u8bf7\u7801\uff081\u4e2a/\u6708\uff09<br/>2\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>3\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf 1\u3001\u8d2d\u4e70\u9080\u8bf7\u7801\uff082\u4e2a/\u6708\uff09<br/>2\u3001\u53d1\u5c04\u4e2a\u6027\u5f39\u5e55\uff08\u5f69\u8272\u3001\u9ad8\u7ea7\u3001\u9876\u90e8\u3001\u5e95\u90e8\uff09<br/>3\u3001\u53c2\u4e0e\u89c6\u9891\u4e92\u52a8\uff08\u8bc4\u8bba\u3001\u6dfb\u52a0tag\uff09<br/>4\u3001\u6295\u7a3f\u6210\u4e3a\u5076\u50cf".split(" ")[w.current_level] + "</div></div>").hide().appendTo(j);
// 		s.mouseenter(function(b) {
// 			clearTimeout(o);
...
// 			300)
// 		});
// 		s.find(".user-info-desc").append(v);
// 		6 == w.current_level ? s.find(".points").css("width", "100%") : s.find(".points").css("width", (100 * (w.current_exp / w.next_exp) >> 0) + "%");
// 		0 == C.email_verified && 0 == C.mobile_verified ? y.after("<div class='link-to-bind-mobile'> <a style='' target='_blank' href='https://passport.bilibili.com/member/bindphone.html'>\u7ed1\u5b9a\u624b\u673a\u53ef\u9886\u53d6\u6bcf\u65e5\u786c\u5e01</a> </div>") : 1 == C.email_verified && 0 == C.mobile_verified && y.after("<div class='link-to-bind-mobile'> <a style='' target='_blank' href='https://passport.bilibili.com/member/hasmailcheckmail.html'>\u7ed1\u5b9a\u624b\u673a\u53ef\u9886\u53d6\u6bcf\u65e5\u786c\u5e01</a> </div>")
// 	}
// }
// window.dynObjects = {};
// window.defaultDynObj = null;
// function initDynWnd(j) {
// 	var q = $('<div id="dyn_wnd"><div class="dyn_menu"><div class="menu"><ul><li mode="video" class="on">\u89c6\u9891<div class="num" id="video_num"></div></li></ul><div class="line"></div></div></div><div class="dyn_list_wrapper view-video" mode="video"><ul class="dyn_list" mode="video"><li class="loading">loading...</li></ul></div><div class="wnd_bottom video"><div class="r-l"><a class="read-more" href="//www.bilibili.com/account/dynamic">\u67e5\u770b\u5168\u90e8</a><div class="num" id="dynamic_num"></div><div class="check-all no-select"></div></div></div></div>'),
// 	i = $("#i_menu_msg_btn");
// 	if (0 != i.length) {
// 		q.appendTo(i);
...
// 				F = "",
// 				r = "",
// 				I = G.archive || G.bangumi;
// 				switch (G.type) {
// 				case 0:
// 					G.official_verify && 0 == G.official_verify.type ? r = '<div class="legalize-14-1" style=\'vertical-align:top;margin-top:2px\' title="\u4e2a\u4eba\u8ba4\u8bc1" ></div>': G.official_verify && 1 == G.official_verify.type && (r = '<div class="legalize-14-2" style=\'vertical-align:top;margin-top:2px\' title="\u4f01\u4e1a/\u56e2\u4f53\u8ba4\u8bc1"></div>');
// 					E = utils.trimHttp(I.pic);
// 					D = I.owner && I.owner.name;
// 					u = 'card="' + I.author + '" mid="' + (I.owner && I.owner.mid) + '"';
// 					A = "<span>\u6295\u7a3f\u4e86</span>";
// 					z = I.title;
// 					y = "//space.bilibili.com/" + (I.owner && I.owner.mid);
// 					v = "//www.bilibili.com/video/av" + I.aid;
// 					F = " v";
// 					break;
// 				case 1:
// 					z = 10 > (I.new_ep && I.new_ep.index) && "number" == typeof I.new_ep.index ? "0": "";
// 					E = utils.trimHttp(I.cover);
// 					D = I.title;
// 					A = "<span>\u66f4\u65b0\u4e86</span>";
// 					H = '<span class="sp">\u756a\u5267</span>';
// 					z = z + (I.new_ep && I.new_ep.index) + " " + (I.new_ep && I.new_ep.index_title) + (I.is_finish ? " \u3010\u5b8c\u7ed3\u3011": "");
// 					y = "//bangumi.bilibili.com/anime/" + I.season_id + "/";
// 					v = "//bangumi.bilibili.com/anime/" + I.season_id + "/play#" + I.new_ep.episode_id;
// 					break;
// 				case 5:
// 					E = utils.trimHttp(G.source.cover);
// 					D = G.source.title;
// 					A = "<span>\u6dfb\u52a0\u4e86</span>";
// 					H = '<span class="sp">\u4e13\u9898</span>';
// 					z = I.title;
// 					y = "//bilibili.com/sp/" + D;
// 					v = utils.trimHttp(I.link);
// 					break;
// 				case 6:
// 					E = utils.trimHttp(G.source.avatar),
// 					D = G.source.uname,
// 					u = 'card="' + G.source.uname + '" mid="' + G.source.mid + '"',
// 					A = "<span>\u53d1\u8868\u4e86\u8bc4\u8bba</span>",
// 					z = G.content.msg,
// 					y = "//space.bilibili.com/" + G.source.mid,
// 					v = utils.trimHttp(I.link + G.content.flink),
// 					F = " u"
// 				}
// 				var t = I.aid ? '<i class="watch-later" aid="' + I.aid + '"></i>': "";
// 				return $('<li class="d-data"><div class="preview' + F + '"><img src="' + utils.trimHttp(utils.webp(E, {
// 					w: 40,
// 					h: 30
// 				})) + '" />' + t + '</div><div class="r"><div class="title">' + (H ? H: "") + r + '<a href="' + y + '"' + ("" != u ? u: "") + ' target="_blank">' + D + "</a>" + A + '</div><div class="info"><a href="' + v + '" target="_blank" title="' + (6 != G.type ? z: I.title) + '">' + utils.unhtml(z) + "</a></div></div></li>")
// 			},
// 			onData: function(d) {
...
// 				var f = parseInt($("#dynamic_num_total").attr("data-dynamic-all") || 0) + parseInt($("#dynamic_num_total").attr("data-dynamic-live") || 0) + parseInt($("#dynamic_num_total").attr("data-dynamic-article") || 0);
// 				0 < f && d.html(f).show();
// 				l.params.total = e
// 			}
// 		});
...
// 					l.init()
// 				}
// 				q.find(".wnd_bottom").hide();
// 				q.find(".wnd_bottom." + $(this).attr("mode")).show()
// 			}
// 		});
...
// 			for (var r = [], q = [], p = [], n = 0; n < k.length; n++) {
// 				r.push(k[n].aid)
// 			}
// 			for (n = 0; n < r.length; n++) {
// 				var l = q.indexOf(r[n]); - 1 == l ? q.push(r[n]) : (q.splice(l, 1), q.push(r[n]), p.splice(l, 1));
// 				p.push(k[n])
// 			}
// 			n = 0;
// 			for (r = p.length; n < r; n++) {
// 				q = 0 === r % 2 ? q = r / 2 : Math.ceil(r / 2),
// 				n < q && (q = p[n], p[n] = p[r - 1 - n], p[r - 1 - n] = q)
// 			}
...
// 		d;
// 		for (d in J) {
// 			if ("object" == typeof J[d]) {
// 				var b = 1000 * J[d].view_at,
// 				P = $('<li class="timeline"><span class="date"></span></li>'),
// 				D = "";
// 				z(b, 0, 1) && !I ? (P.find(".date").html("\u4eca\u65e5"), P.appendTo(K), I = !0) : z(b, 1, 2) && !G ? (P.find(".date").html("\u6628\u65e5"), P.appendTo(K), G = !0) : z(b, 2, 8) && !H ? (P.find(".date").html("\u8fd11\u5468"), P.appendTo(K), H = !0) : z(b, 8, 31) && !e ? (P.find(".date").html("1\u5468\u524d"), P.appendTo(K), e = !0) : z(b, 31, 91) && !F ? (P.find(".date").html("1\u4e2a\u6708\u524d"), P.appendTo(K), F = !0) : z(b, 0, 1) || (z(b, 1, 2) || z(b, 2, 8) || !z(b, 8, 31) || z(b, 31, 91)) || (P.find(".date").html((new Date(1000 * J[d].view_at)).format("yyyy-MM-dd hh:mm:ss")), P.appendTo(K));
// 				if (UserStatus.status().isLogin && -1 < J[d].type) {
// 					var N = P = D = b = "",
// 					L = "",
// 					b = L = "";
// 					0 < J[d].progress && (L = "?t=" + J[d].progress);
// 					b = 2 === J[d].device || 33 === J[d].device ? "pc": 1 === J[d].device || 3 === J[d].device || 5 === J[d].device || 7 === J[d].device ? "phone": 4 === J[d].device || 6 === J[d].device ? "pad": "unknown";
// 					J[d].page && (D = Math.round(100 * (J[d].progress / J[d].page.duration)), D = 0 === D ? "1%": D + "%", -1 === J[d].progress || -1 < J[d].progress && J[d].page && 30 > J[d].page.duration - J[d].progress) && (D = "100%");
// 					if (1 === J[d].type && J[d].bangumi) {
// 						P = D ? "&nbsp;|&nbsp;": "",
// 						P = isNaN(Number(J[d].bangumi.title)) ? J[d].bangumi.title + P: "\u7b2c" + J[d].bangumi.title + "\u8bdd" + P,
// 						N = J[d].bangumi.season.title,
// 						L = "//bangumi.bilibili.com/anime/" + J[d].bangumi.season.season_id + "/play" + L + "#" + J[d].bangumi.ep_id
// 					} else {
// 						if (J[d].page) {
// 							var Q = "",
// 							N = J[d].title;
// 							J[d].count && 1 < J[d].count && (P = "\u7b2c" + J[d].page.page + "P&nbsp;|&nbsp;", Q = "/index_" + J[d].page.page + ".html");
// 							L = y + "/video/av" + J[d].aid + Q + L
// 						} else {
// 							N = J[d].title,
// 							L = y + "/video/av" + J[d].aid + L
// 						}
// 					}
// 					D = '<div class="device"><span class="pages">' + P + '</span><span class="progress">' + D + '</span><i class="device-i ' + b + '"></i></div>';
// 					b = $('<li><a  class="item-a" href="' + L + '" target="_blank" title="' + N + '" data-aid="' + J[d].aid + '">' + N + "</a>" + D + "</li>")
// 				} else {
// 					b = $('<li><a  class="item-a" href="' + y + "/video/av" + J[d].aid + '" target="_blank" title="' + J[d].title + '" data-aid="' + J[d].aid + '">' + J[d].title + "</a></li>")
// 				}
// 				b.appendTo(K)
// 			}
// 		}
// 		0 == K.children().length && (K.addClass("empty"), $('<li class="no-data">\u6ca1\u6709\u6570\u636e\u54e6\uff0c\u591a\u770b\u70b9\u89c6\u9891\u5427</li>').appendTo(K))
// 	}
// 	function B(b) {
// 		return {
// 			year: b.getFullYear(),
...
// 		return l
// 	}
// 	var y = "//www.bilibili.com",
// 	x = $("#i_menu_fav_btn"),
// 	w = $("#i_menu_history_btn"),
// 	v = new MiniWnd;
// 	if (x.length && UserStatus.status().isLogin) {
// 		var t = {
// 			wnd: $('<div class="mini-wnd"><ul class="list"></ul><a class="read-more" href="//space.bilibili.com/' + (UserStatus.status().mid || utils.__GetCookie("DedeUserID")) + '/#!/favlist" target="_blank">\u67e5\u770b\u66f4\u591a<i class="b-icon b-icon-arrow-r"></i></a></div>'),
...
// 				l.empty();
// 				for (var h in k) {
// 					"object" == typeof k[h] && (null != k[h].title ? $('<li><a href="' + y + "/video/av" + k[h].aid + '" target="_blank" title="' + k[h].title + '">' + k[h].title + "</a></li>") : $('<li><a href="' + y + "/mylist" + k[h].lid + '" target="_blank" title="' + k[h].description + '">' + k[h].description + "</a></li>")).appendTo(l)
// 				}
...
// 			var x = {
// 				wnd: $('<div class="mini-wnd hsmini onlinehs-mini"><div class="top-open-history"><p class="txt">\u5386\u53f2\u529f\u80fd\u6682\u505c\u4e2d\uff0c\u5c31\u7b97\u770b\u4e0d\u53ef\u63cf\u8ff0\u7684\u89c6\u9891\u4e5f\u4e0d\u4f1a\u88ab\u8bb0\u5f55\u4e0b\u6765\u4e86</p><a class="openbtn">\u524d\u53bb\u5f00\u542f</a></div><ul class="list history"></ul><a class="read-more">\u67e5\u770b\u66f4\u591a<i class="b-icon b-icon-arrow-r"></i></a></div>'),
...
// 				var j = $('iframe[src="//www.bilibili.com/html/iframemessage.html"]')[0];
// 				j || "bilibili" != document.domain.split(".")[1] || (document.domain = "bilibili.com", j = document.createElement("iframe"), j.style.cssText = "position:absolute;width:1px;height:1px;left:-9999px;", j.src = "iframemessage.html", document.body.appendChild(j), $(j).load(function() {
// 					s = j.contentWindow.localStorage;
// 					o = C(o, s);
// 					var a = {
// 						wnd: $('<div class="mini-wnd hsmini"><div class="top-login"><p class="txt">\u767b\u5f55\u540e\u6709\u66f4\u591a\u529f\u80fd\u54e6\uff5e</p><a class="loginbtn" href="https://passport.bilibili.com/login">\u767b\u5f55</a></div><ul class="list history"></ul><a class="read-more" href="//www.bilibili.com/account/history">\u67e5\u770b\u66f4\u591a<i class="b-icon b-icon-arrow-r"></i></a></div>'),
// 						data: {
// 							data: o
// 						},
// 						render: function(d, c) {
...
// 		}
// 	}
// 	u && UserStatus.status().isLogin && (x = {
// 		wnd: $('<div class="mini-wnd"><ul class="list"></ul><a class="read-all" href="//www.bilibili.com/watchlater/" target="_blank">\u64ad\u653e\u5168\u90e8<i class="b-icon b-icon-arrow-r"></i></a><a class="play-all" href="//www.bilibili.com/watchlater/#/list" target="_blank">\u67e5\u770b\u5168\u90e8<i class="b-icon b-icon-arrow-r"></i></a></div>'),
...
// 					var k = "1";
// 					n[l].pages && n[l].pages.forEach(function(d, c) {
// 						k = n[l].cid == d.cid ? 1 + c: k
// 					});
// 					$('<li><a href="//www.bilibili.com/watchlater/#/av' + n[l].aid + "/p" + k + '" target="_blank" title="' + n[l].title + '">' + n[l].title + "</a></li>").appendTo(p)
// 				}
// 			}
// 			0 == p.children().length && $('<li class="no-data">\u6ca1\u6709\u6570\u636e\u54e6\uff0c\u591a\u6536\u85cf\u70b9\u89c6\u9891\u5427</li>').appendTo(p)
// 		}
// 	},
// 	v.init(u, x));
// 	u = $(".hsmini");
// 	w.find(".i-link").off().on("click",
// 	function(b) {
// 		b.preventDefault();
// 		rec_rp("event", "nav_righttoolbar_history_click");
// 		window.open("http://www.bilibili.com/account/history")
// 	});
// 	u.find(".openbtn").on("click",
// 	function(b) {
// 		b.preventDefault();
// 		window.open("http://www.bilibili.com/account/history")
// 	});
// 	u.find(".read-more").on("click",
// 	function(b) {
// 		b.preventDefault();
// 		rec_rp("event", "nav_righttoolbar_history_more_click");
// 		window.open("http://www.bilibili.com/account/history")
// 	});
// 	u.find(".list").on("click",
// 	function(b) {
// 		b.preventDefault();
...
// 	i.length && $.ajax({
// 		url: "//api.bilibili.com/x/v2/history/shadow",
// 		type: "get",
// 		data: {
// 			jsonp: "jsonp"
// 		},
...
// 		dataType: "json",
// 		success: function(b) {
// 			0 === b.code && (b.data ? i.show() : i.hide())
// 		}
// 	})
// }
// onLoginInfoLoaded(function(b) {
// 	b.isLogin && (b = $(".mini-wnd"), b.children().length && (b.remove(), initMiniWnd()))
// },
// !0);
...
// 	var h = $("#dyn_wnd"),
// 	l = utils.protocolRelative("http://api.live.bilibili.com/ajax/"),
// 	g = h.find(".menu"),
// 	g = $('<li mode="live">\u76f4\u64ad<div class="num" id="live_num"></div></li>').insertAfter(g.find('li[mode="video"]')),
// 	k = $('<div class="dyn_list_wrapper view-live"></div>').insertAfter(h.find(".dyn_list_wrapper:eq(" + (g.index() - 1) + ")")).attr("mode", "live").hide(),
// 	j = $('<ul class="dyn_list"><li class="loading">loading...</li></ul>').attr("mode", "live").appendTo(k);
...
// 		var b = parseInt($("#dynamic_num_total").attr("data-dynamic-all") || 0) + parseInt($("#dynamic_num_total").attr("data-dynamic-live") || 0) + parseInt($("#dynamic_num_total").attr("data-dynamic-article") || 0);
// 		$("#dynamic_num_total").html(b);
// 		1 > b && $("#dynamic_num_total").hide()
// 	});
// 	$('<div class="wnd_bottom live"><div class="r-l"><a class="btn-live-more" href="//link.bilibili.com/p/eden/subscription#/?cur=live" target="_blank">\u6240\u6709\u5173\u6ce8</a></div></div>').insertAfter(k).hide();
// 	var i = new dynManage(h);
// 	window.dynObjects.live = i;
// 	$.get(l + "feed/count",
// 	function(d) {
// 		var c = d.data && d.data.count;
// 		$("#dynamic_num_total").attr("data-dynamic-live", c);
// 		c = parseInt($("#dynamic_num_total").attr("data-dynamic-all") || 0) + parseInt($("#dynamic_num_total").attr("data-dynamic-live") || 0) + parseInt($("#dynamic_num_total").attr("data-dynamic-article") || 0);
// 		0 == d.code && d.data.count && ($("#live_num").show(), $("#dynamic_num_total").html(c).show())
// 	},
// 	"jsonp")
// }
// function initArticleDyn() {
// 	var f = $("#dyn_wnd"),
// 	h = f.find(".menu"),
// 	h = $('<li mode="article">\u4e13\u680f<div class="num" id="article_num"></div></li>').insertAfter(h.find('li[mode="live"]')),
// 	e = $('<div class="dyn_list_wrapper view-article" mode="article" style="margin-bottom:10px"><ul class="dyn_list" mode="article"><li class="loading">loading...</li></ul></div>').insertAfter(f.find(".dyn_list_wrapper:eq(" + (h.index() - 1) + ")")).hide();
// 	e.smoothScroll();
// 	f = {
// 		type: "article",
// 		apiUrl: utils.protocolRelative("//api.bilibili.com/x/web-feed/article/feed"),
// 		wnd: $("#dyn_wnd"),
// 		data: {
// 			jsonp: "jsonp",
// 			ps: 5,
// 			type: 0
// 		},
// 		target: $('.dyn_list[mode="article"]', f),
// 		menuItem: $('.dyn_menu li[mode="article"]', f),
// 		append: function(y) {
// 			var x = "",
// 			w = "",
// 			v = "",
...
// 			j = "",
// 			i = "";
// 			y.author.official_verify && 0 == y.author.official_verify.type ? i = '<div class="legalize-14-1" style=\'vertical-align:top;margin-top:2px\' title="\u4e2a\u4eba\u8ba4\u8bc1" ></div>': y.author.official_verify && 1 == y.author.official_verify.type && (i = '<div class="legalize-14-2" style=\'vertical-align:top;margin-top:2px\' title="\u4f01\u4e1a/\u56e2\u4f53\u8ba4\u8bc1"></div>');
// 			x = utils.trimHttp(y.image_urls[0]);
// 			w = y.author && y.author.name;
// 			s = 'card="' + y.author + '" mid="' + (y.author && y.author.mid) + '"';
// 			v = "<span>\u6295\u7a3f\u4e86</span>";
// 			t = y.title;
// 			u = "//space.bilibili.com/" + (y.author && y.author.mid);
// 			o = "//www.bilibili.com/read/cv" + y.id;
// 			j = " v r";
// 			x = x ? '<a href="' + o + '" target="_blank"><img src="' + utils.trimHttp(utils.webp(x, {
// 				w: 80,
// 				h: 60
// 			})) + '" /></a>': "";
// 			y = $('<li class="d-data"><div class="preview' + j + '">' + x + '</div><div class="r"><div class="title">' + i + '<a href="' + u + '"' + ("" != s ? s: "") + ' target="_blank">' + w + "</a>" + v + '</div><div class="info"><a href="' + o + '" target="_blank" title="' + (6 != y.type ? t: y.title) + '">' + utils.unhtml(t) + "</a></div></div></li>");
// 			y.find("img").on("load",
// 			function() {
// 				80 === this.width ? $(this).css({
// 					height: "30px",
// 					marginLeft: (40 - 80 / (this.height / 30)) / 2
// 				}) : $(this).css({
// 					width: "40px",
// 					marginTop: (40 - 80 / (this.width / 30)) / 2
// 				})
// 			});
// 			return y
// 		},
...
// 		$("#article_num").hide()
// 	});
// 	$('<div class="wnd_bottom article"><div class="r-l"><a class="btn-article-more" href="//www.bilibili.com/read/home" target="_blank">\u8fdb\u5165\u4e13\u680f\u533a</a></div></div>').insertAfter(e).hide();
// 	var g = new dynManage(f);
// 	window.dynObjects.article = g;
// 	$.ajax({
// 		url: "//api.bilibili.com/x/web-feed/article/unread",
// 		data: {
// 			jsonp: "jsonp"
// 		},
// 		dataType: "jsonp",
...
// 		success: function(i) {
// 			var d = $("#dynamic_num_total");
// 			i = i.data && i.data.count;
// 			$("#dynamic_num_total").attr("data-dynamic-article", i);
// 			var j = parseInt($("#dynamic_num_total").attr("data-dynamic-all") || 0) + parseInt($("#dynamic_num_total").attr("data-dynamic-live") || 0) + parseInt($("#dynamic_num_total").attr("data-dynamic-article") || 0);
// 			0 < j && d.html(j).show();
// 			0 < i && $("#article_num").show();
// 			g.params.total = i
// 		}
// 	})
// }
...
// 	this.noDataTxt = this.params.noDataTxt || "";
...
// 	try {
// 		var u = (new Date).getSeconds() % E.length,
// 		x = E[u];
// 		if ("banner" == F) {
// 			if (0 < $(".header .logo").length) {
// 				var o = $(".header .logo"),
// 				s = $('<div class="bili_live_pmt" b-stat="float-pmt-banner" b-stat-v="' + x[1] + '"><a href="' + x[1] + '" target="_blank"></a></div>').css({
// 					width: B || 150,
// 					height: A || 80,
// 					"margin-top": -20,
...
// 			I = $(".z");
// 			if (I.length) {
// 				var H = $("<a>").addClass("float-pmt").attr({
// 					id: "a_ds_" + D,
// 					href: x[1],
// 					target: "_blank",
// 					"b-stat": "float-pmt",
...
// 					position: "absolute",
// 					right: -F,
// 					top: $(window).scrollTop() + $(window).height() - I.offset().top - i - 220,
// 					height: i,
// 					width: F,
// 					"z-index": 10050
// 				});
...
// 				function() {
// 					H.css("top", $(window).scrollTop() + $(window).height() - I.offset().top - i - 220)
// 				});
// 				return H
// 			}
// 		}
...
// 			if ("nan" == j.sort || "NaN" == j.sort) {
// 				j.sort = "0"
// 			}
// 			0.999 < Math.random() && rec_rp("event", "index_page_nav_sort", {
// 				sort: j.sort
// 			});
...
// 			function() {
// 				d.scrolling = 0
// 			}), utils.customReport("playpage_top"))
// 		})
// 	},
// 	bindScroll: function() {
// 		var b = this;
...
// 		} else {
// 			this._xhr = $.ajax({
// 				url: utils.protocolRelative("http://www.bilibili.com/plus/widget/ajaxGetCaptchaKey.php"),
// 				dataType: "json",
// 				async: this.async,
// 				success: function(e) {
...
// 			f = c.element,
// 			c = c.callback;
// 			f.attr("loaded") || ("wrap" != this.config.mode || f.parent(".img-loading").length ? "wrap" != this.config.mode && f.attr("src", utils.trimHttp(this.config.defaultImg)) : (f.attr("src", "./images/transparent.gif"), f.wrap(this.wrapper).parent().css({
...
// 	}
// 	function p(h, g) {
// 		var u = g.parents("#dyn_wnd").length,
// 		t = g.hasClass("block"),
// 		s = "",
// 		r = "add_watchlater";
// 		window.aid && (s = "playpage");
// 		window.tid && (s = "channels");
// 		/ranking/.test(location.pathname) && (s = "rankpage");
// 		/dynamic/.test(location.pathname) && (s = "dynamic");
// 		u && (s = "navdynamic_hover");
// 		t && (s = "", r = "arc_watchlater");
// 		u = {};
// 		u = "del" === h ? {
// 			source: s,
// 			action: h
...
// 			},
// 			success: function(a) {
// 				0 === a.code ? (e.removeClass("on"), n(e, "\u5df2\u4ece\u7a0d\u540e\u518d\u770b\u5217\u8868\u4e2d\u79fb\u9664")) : n(e, a.message);
...
// 			},
// 			success: function(a) {
// 				0 === a.code ? (e.addClass("on"), n(e, "\u5df2\u52a0\u7a0d\u540e\u518d\u770b")) : n(e, a.message);
// 				f && "function" == typeof f && f()
// 			},
// 			error: function() {
// 				n(e, "\u6dfb\u52a0\u5931\u8d25\uff0c\u8bf7\u91cd\u8bd5")
...
// 		var u = h.offset(),
// 		t = h.innerWidth();
// 		k = $('<div class="watch-later-tip">' + g + "</div>");
// 		$("body").append(k);
// 		k.show();
// 		var s = k.innerHeight(),
// 		r = k.innerWidth();
// 		k.css({
// 			top: u.top - s - 3 + "px",
// 			left: u.left - r / 2 + t / 2 + "px"
// 		}).addClass("on")
// 	}
// 	var l = [],
// 	k;
// 	window.listenWatchLaterIcon = function(a) {
// 		a = $(a);
// 		l.push(a[0]);
// 		q(a);
// 		j(a)
...
// 			$(document).off("mousedown.addWatchLater").on("mousedown.addWatchLater", ".watch-later-like",
// 			function(b) {
// 				b = $(b.currentTarget);
// 				0 <= l.indexOf(b[0]) || i(b)
// 			});
// 			$(document).off("mouseenter.addWatchLater").on("mouseenter.addWatchLater", ".watch-later-like",
// 			function(b) {
// 				b = $(b.target);
// 				0 <= l.indexOf(b[0]) || (b.hasClass("on") ? n(b, "\u79fb\u9664") : n(b, "\u7a0d\u540e\u518d\u770b"))
// 			});
// 			$(document).off("mouseleave.addWatchLater").on("mouseleave.addWatchLater", ".watch-later-like",
// 			function() {
// 				k && k.remove()
// 			})
// 		})
// 	})()
// })();
// var SliderController = function(b) {
...
// 			2 == arguments.length && "function" === typeof b ? (a = b, b = "//static.hdslb.com/" + (d[c] || e(c, c))) : 1 == arguments.length && (b = "//static.hdslb.com/" + (d[c] || e(c, c)));
// 			window[c] ? a && a(window[c]) : f[c] || (f[c] = f[c] || [], a && f[c].push(a), $.ajax({
// 				url: b,
// 				dataType: "script",
// 				cache: !0,
// 				success: function(g) {
...
// 		function(e) {
// 			if (!e.random_link || !e.random_link.length || 0 != e.random_link.recommend.code || 0 != Math.floor(2 * Math.random()) && e.fix.length) {
// 				e.fix.sort(function(v, f) {
...
// 			} else {
// 				for (o = 0; o < e.random.length; o++) {
// 					q.push(e.random[o])
// 				}
// 				for (n in e.random_link.recommend.list) {
// 					if ("object" == typeof e.random_link.recommend.list[n]) {
// 						for (i = 0; i < e.random_link.recommend.list[n].length; i++) {
// 							r.push(e.random_link.recommend.list[n][i])
// 						}
// 					}
// 				}
// 				j = u(q);
...
// 					var d = "./activity/bnj2016/img/fire1.gif",
// 					l = $(),
// 					k = $("<div>").css({
// 						left: 0
// 					}).append($("<img>").css({
...
// 							l.appendTo(".header .menu-wrapper").css({
// 								position: "absolute",
// 								overflow: "hidden",
// 								top: -10,
// 								zIndex: 20000,
...
// 							k.css("left", -(k.width() - 50)).find("img").attr("src", utils.trimHttp("./activity/bnj2016/img/fire4.gif"));
// 							h.css("right", -(k.width() - 50)).find("img").attr("src", utils.trimHttp("./activity/bnj2016/img/fire3.gif"));
// 							0 > k.offset().left && k.width(parseInt($(".header .menu-wrapper").offset().left + 50)).css("left", -(k.width() - 50));
// 							h.offset().left + h.width() > $(window).width() && h.width(parseInt($(window).width() - $(".header .menu-wrapper").offset().left - $(".header .menu-wrapper").outerWidth() + 50)).css("right", -(k.width() - 50))
// 						},
// 						100)
// 					}).on("mouseleave",
// 					function() {
...
// 				}
// 				a.attr({
// 					src: utils.trimHttp(d),
// 					alt: j.title
// 				});
// 				c.append(a);
// 				d = -1 != String(j.link).indexOf("search.bilibili.com") ? j.link + "&from_source=gif_recommend": j.link;
// 				t.attr({
// 					href: utils.trimHttp(d),
// 					title: j.title
// 				});
// 				e.ea_public && (0 == e.ea_public.code && -1 != e.ea_public.result) && GlobalView.notice(e.ea_public.result)
// 			} else {
// 				t.remove()
// 			}
// 		})
...
// 			mz: "//bangumi.bilibili.com/moe/2017/header/index"
// 		};
...
// 		function() {
// 			var d = h.val(),
// 			c = $(this).attr("suggestion");
// 			h.siblings('input[name="from_source"]').remove();
// 			c ? (h.after('<input name="from_source" value="banner_suggest" type="hidden" />'), $(this).removeAttr("suggestion")) : "" == d && h.attr("data-recommend") ? h.after('<input name="from_source" value="banner_recommend" type="hidden" />') : d && "search-keyword" == h.attr("id") ? h.after('<input name="from_source" value="banner_search" type="hidden" />') : d && "nav_search_keyword" == h.attr("id") && h.after('<input name="from_source" value="nav_search" type="hidden" />');
// 			if ("" == d && h.attr("data-recommend")) {
// 				h.val(h.attr("data-recommend"))
// 			} else {
// 				if ("" == d) {
// 					return window.open("http://search.bilibili.com/", i.attr("target")),
// 					!1
// 				}
// 			}
...
// 		})
// 	});
// 	window.bNavigator || (0 != $("#index_container").length || 0 != $(".rocket-con").length) || new IndexNavigator;
...
// 		countInfo.c177 && (g += countInfo.c177);
// 		g && $(".addnew_177_23_11").html(999 >= g ? g: "999+");
...
// 			}
// 			var f;
// 			d.item.isHistory ? (f = i.form.attr("action"), i.form.attr("action", i.makeSearchUrl("all"))) : i.form.attr("suggestion", 1);
// 			i.form.submit();
...
// 			"string" !== typeof f || "//www.bilibili.com/" != location.href && "//www.bilibili.com/index.html" != location.href || (c = f.split("https://www.bilibili.com/")[3]);
...
// 		177 : "2260"
// 	};
// 	b = b || $(".header .num .m-i.on").attr("data-tid") || window.tid;
...
// 		"post" != c.type && "POST" != c.type || (!c.data || c.data.csrf) || b.extend(c.data, {
...
// })(jQuery);
// $(function() {
// 	$(".z_header .s-menu").addClass("music-show")
// });
// $(function() {
// 	utils.cookie.get("articleEntryIcon") || ($(".u-i.b-post").append('<i class="up-new"></i>'), $(".s-menu .article a").append('<i class="new"></i>').click(function() {
// 		utils.cookie.set("articleEntryIcon", 1)
// 	}));
// 	$(".s-menu .music-up a").append('<i class="beta"></i>')
// });
// $(function() {
// 	function h() {
// 		j -= 3;
// 		i -= 3; - 320 > j && (j = 320); - 320 > i && (i = 320);
// 		$("#i_menu_login img").eq(0).css("left", j);
// 		$("#i_menu_login img").eq(1).css("left", i)
// 	}
// 	function l() {
// 		k = setTimeout(function() {
// 			$("#i_menu_login").slideUp(function() {
// 				clearInterval(g)
// 			})
// 		},
// 		500)
...
// 	var g, k, j = 0,
// 	i = 320;
// 	$("#i_menu_login img").eq(1).css("left", i); (new Date).getTime() > localStorage.getItem("loginBubbleRequire") && "www" === window.location.host.substr(0, 3) && ($("#i_menu_login").show(), g = setInterval(h, 50), $("body").click(function(b) {
// 		b = $(b.target);
// 		b.is("#i_menu_login") || 0 < b.parents("#i_menu_login").length || l()
// 	}), $(window).scroll(function() {
// 		160 < window.pageYOffset && l()
// 	}), localStorage.setItem("loginBubbleRequire", (new Date).getTime() + 604800000));
// 	$("#i_menu_login, #login_default_face").on("mouseenter",
// 	function() {
// 		clearTimeout(k);
// 		$("#i_menu_login").slideDown();
// 		$("#i_menu_login_reg").off("mouseleave", l).on("mouseleave", l);
// 		clearInterval(g);
// 		g = setInterval(h, 50)
// 	});
// 	$("#i_menu_history_btn, .b-post").on("mouseenter", l);
// 	window.onLoginInfoLoaded(function(b) {
// 		b.isLogin && localStorage.setItem("loginBubbleRequire", (new Date).getTime() + 604800000)
// 	})
// });
// $(function() {
// 	$(".member-menu .ticket").attr("href", "http://show.bilibili.com/orderlist")
// });
// $(function() {
// 	$(".watch-later").addClass("watch-later-like")
// });